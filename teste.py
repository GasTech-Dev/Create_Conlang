# Chaîne initiale avec les langues et leurs codes
languages_str = """
...
language_name = input("Entrez le nom de la langue : ").lower().strip()

# Vérification et affichage du résultat
result = languages_dict.get(language_name, "Langue non trouvée")
print(result)
